...
/* if 'macronix,mx25rxx' return controller label or punt to _else_code */
#define IS_MACRONIX_MX25RXX(part, _else_code) \
	COND_CODE_1(DT_NODE_HAS_COMPAT(GPARENT(part), macronix_mx25rxx), \
		    (DT_LABEL(GPARENT(part))), (_else_code))
